    ...
    <div class="container mt-5">
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-4 text-center">
                <img src="{{ asset('images/member1.jpg') }}" alt="Team Member 1" class="img-fluid rounded-circle mb-3" width="150">
                <h4>John Doe</h4>
                <p>Lead Developer</p>
                <p>John has over 10 years of experience in full-stack development, focusing on building scalable web applications.</p>
            </div>
            ...
            <div class="col-md-4 text-center">
                ...
                <h4>Jane Smith</h4>
                <p>UI/UX Designer</p>
                <p>Jane is passionate about creating intuitive user experiences. She ensures that our platform is user-friendly and aesthetically pleasing.</p>
            </div>

            <!-- Anggota Tim 3 -->
            <div class="col-md-4 text-center">
                <img src="{{ asset('images/member3.jpg') }}" alt="Team Member 3" class="img-fluid rounded-circle mb-3" width="150">
                <h4>Mark Lee</h4>
                <p>Backend Developer</p>
                <p>Mark specializes in server-side development. He handles databases, APIs, and ensures our platform is robust and secure.</p>
            </div>
        </div>
